...
namespace Graphs
{
    sealed class BFS
    {
        ...
        public void _BFSTraverse(Graph graph, string startingNode)
        {
        ...
        /// </summary>
        public bool _BFSConfirmPath(Graph graph, string startingNode, string goalNode)
        {
        ...
        public List<string> _BFSPathfind(Graph graph, string startingNode, string toNode)
        {
            //Fast return if the starting node does not exist in the node graph
            if (!graph.IsNode(startingNode))
            {
